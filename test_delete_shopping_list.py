...
class DeleteShoppingListTests(unittest.TestCase):
    ...
    def test_delete_shopping_list_functionality(self):
        ...
        with app.test_client() as client:
            ...
            rv4 = client.post('/delete/shopping-list', data=dict(
            ...
            self.assertNotIn(gotten_object["id"], session["shopping-lists"],
                "The shopping list has not been deleted as expected")
    ...
    def test_delete_shopping_list_as_guest_functionality(self):
        ...
        with app.test_client() as client:
            ...
            rv5 = client.post('/delete/shopping-list', data=dict(
                id=gotten_object["id"]), follow_redirects=True)
            ...
            self.assertIn(gotten_object["id"], session["shopping-lists"],
                "The shopping list has been deleted by a guest user")
    ...
    def test_delete_shopping_list_id_required(self):
        ...
        with app.test_client() as client:
            ...
            rv5 = client.post('/delete/shopping-list', follow_redirects=True)
            ...
            self.assertEqual(
                    ...
                    "The logout page was not loaded as expected")
            self.assertIn(gotten_object["id"], session["shopping-lists"],
                "The shopping list has been deleted without its id")