...
class UpdateShoppingListItemTests(unittest.TestCase):
    ...
    def test_update_shopping_list_item_functionality(self):
        ...
        with app.test_client() as client:
            ...
            rv4 = client.post('/update/shopping-list/item/'+shopping_list["id"], data=dict(
            ...
            self.assertEqual(
                rv3.status_code, 200, 
                "The create shopping list item page was not loaded as expected")
            self.assertEqual(
                True, exists, 
